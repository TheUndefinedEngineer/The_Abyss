...
3. **Linker script (`stm32f401.ld`)** — tells the linker where flash and RAM are, how big they are, and how to arrange your sections (`.text`, `.data`, `.bss`). Without this, the linker has no idea it's targeting an STM32.
